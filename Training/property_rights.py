...
source_name = 'heritage.org Index of Economic Freedom for land use rights'
...
df2 = df[['Country','Property Rights']].dropna().reset_index(drop=True)
...
for i in range(rows):
    ...
    description = "The Property Rights score for " + country + " in the year " + year + " is " + str(property_right_score) + ". This score is normalised on a risk scale between 1(best) and 6(worst)."
